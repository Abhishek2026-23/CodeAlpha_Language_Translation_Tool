...
def translate_text():
    try:
        ...
        # Enhanced translation dictionary with more examples
        translations = {
            ('hello', 'es'): 'hola',
